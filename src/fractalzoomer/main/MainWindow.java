...
//    }
    ...
    public MainWindow() {
        ...
        common = new CommonFunctions(scroll_pane);
...
//                }
    ...
    public void savePreferences() {
        ...
        try {
            ...
            writer.println("high_precision_implementation " + TaskRender.HIGH_PRECISION_IMPLEMENTATION);
...
//                    }
                        ...
                        try {
                            ...
                            if (temp >= 0 && temp <= 6) {
                                TaskRender.HIGH_PRECISION_IMPLEMENTATION = temp;
                            }
                        } catch (Exception ex) {
                        }
                    }
