...
public interface Constants {
    ...
    public static final String[] colorSpaces = {"RGB", "HSB", "Exp", "Square", "Sqrt", "RYB", "Lab", "XYZ", "LCH_ab", "Bezier RGB", "HSL", "Luv", "LCH_uv", "OKLab", "LCH_oklab", "JzAzBz", "LCH_JzAzBz", "HSL_uv", "HPL_uv", "HWB", "Linear sRGB", "yCbCr", "Cubehelix", "HSB(L)", "HSL(L)", "LCH_ab(L)", "LCH_uv(L)", "LCH_oklab(L)", "LCH_JzAzBz(L)", "HSL_uv(L)", "HPL_uv(L)", "HWB(L)", "Cubehelix(L)"};
    ...
    public static final int COLOR_SPACE_HSB_LONG = 23;
    public static final int COLOR_SPACE_HSL_LONG = 24;
    public static final int COLOR_SPACE_LCH_ab_LONG = 25;
    public static final int COLOR_SPACE_LCH_uv_LONG = 26;

    public static final int COLOR_SPACE_LCH_oklab_LONG = 27;
    public static final int COLOR_SPACE_LCH_JzAzBz_LONG = 28;

    public static final int COLOR_SPACE_HSL_uv_LONG = 29;

    public static final int COLOR_SPACE_HPL_uv_LONG = 30;

    public static final int COLOR_SPACE_HWB_LONG = 31;
    public static final int COLOR_SPACE_CUBEHELIX_LONG = 32;
    /**
     * *******************
     */
