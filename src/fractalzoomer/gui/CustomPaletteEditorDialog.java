 ...
 * @author hrkalona
 */
public class CustomPaletteEditorDialog extends JDialog {

    private static final long serialVersionUID = -5234702415922634911L;
    private CustomPaletteEditorDialog this_frame;
    ...
    public CustomPaletteEditorDialog(MainWindow ptra, final JRadioButtonMenuItem[] palette, boolean smoothing, final int palette_id, final int color_choice, int[][] custom_palette, int color_interpolation2, int color_space2, boolean reversed_palette2, int temp_color_cycling_location2, double scale_factor_palette_val2, int processing_alg2, final boolean outcoloring_mode) {
        ...
        int custom_palette_window_width = 990 + (MainWindow.useCustomLaf ? extraWidth : 0);
        int custom_palette_window_height = 655 + (MainWindow.useCustomLaf ? extraHeight : 0);
        ...
        editor_panel.setPreferredSize(new Dimension(910 + (MainWindow.useCustomLaf ? extraWidth : 0), 495 + (MainWindow.useCustomLaf ? extraHeight : 0)));
        editor_panel.setLayout(new FlowLayout());
        editor_panel.setBackground(MainWindow.bg_color);
        tools.setLayout(new FlowLayout());
        tools.setPreferredSize(new Dimension(890 + (MainWindow.useCustomLaf ? extraWidth : 0), 95));
        tools.setBackground(MainWindow.bg_color);
        palette_colors.setLayout(new FlowLayout());
        palette_colors.setPreferredSize(new Dimension(890 + (MainWindow.useCustomLaf ? extraWidth : 0), 80 + (MainWindow.useCustomLaf ? extraHeight : 0)));
            ...
            labels[k].addMouseListener(new MouseListener() {
                ...
                public void mousePressed(MouseEvent e) {
                    ...
                    if (!add_palette.isSelected() && !minus_palette.isSelected() && !swap_palette.isSelected() && !copy_palette.isSelected()) {
                        new ColorChooserDialog(this_frame, "Choose Color", labels[temp], temp, -1);
        ...
        for (int k = 0; k < labels.length; k++) {
            ...
            textfields[k].setHorizontalAlignment(JTextField.CENTER);
            ...
            textfields[k].addFocusListener(new FocusListener() {
                ...
                public void focusLost(FocusEvent e) {
                    textfields[temp2].setCaretPosition(0);
                }
            });
        ...
        colors = new BufferedImage(868 + (MainWindow.useCustomLaf ? extraWidth : 0), 36, BufferedImage.TYPE_INT_ARGB);

        colors2 = new BufferedImage(868 + (MainWindow.useCustomLaf ? extraWidth : 0), 145, BufferedImage.TYPE_INT_ARGB);
        ...
        if(MainWindow.useCustomLaf) {
            colors = CommonFunctions.makeRoundedCorner(colors, 5);
        }
        ...
        options_panel.setPreferredSize(new Dimension(325 + (MainWindow.useCustomLaf ? extraWidth / 2 : 0), 60));
        ...
        pastel_cb.setSelected(CustomPaletteEditorDialog.pastel);
        ...
        processing_palette.setPreferredSize(new Dimension(244 + (MainWindow.useCustomLaf ? extraWidth / 2 : 0), 60));
        ...
        if(!MainWindow.useCustomLaf) {
            gradient.setBorder(LAFManager.createSimpleBorder());
        }
        ...
        random_palette.addActionListener(e -> {
            ...
            Color[] c18 = randomPalette(TaskRender.generator, true, temp_custom_palette, combo_box_random_palette_alg.getSelectedIndex(), same_hues.isSelected(), combo_box_color_interp.getSelectedIndex(), combo_box_color_space.getSelectedIndex(), check_box_reveres_palette.isSelected(), temp_color_cycling_location, (scale_factor_palette_slid.getValue() - scale_factor_palette_slid.getMaximum() / 2.0) / (scale_factor_palette_slid.getMaximum() / 2.0), combo_box_processing.getSelectedIndex(), pastel_cb.isSelected());
        ...
        color_picker.addActionListener(e -> {
            ...
            final RoundedPanel panel2 = new RoundedPanel(false, true, true, 10);
            ...
            ptra2.setState(Frame.ICONIFIED);
            color_picker_frame.setVisible(true);

            future = TaskRender.single_thread_executor.submit(color_picker_thread);
        });
        ...
        graph.setBorder(LAFManager.createSimpleBorder());

        JPanel palette_panel = new JPanel();
        palette_panel.setBackground(MainWindow.bg_color);
        palette_panel.setPreferredSize(new Dimension(890 + (MainWindow.useCustomLaf ? extraWidth : 0), 238));
        ...
        palette_colors.setBorder(LAFManager.createTitledBorder("Colors/Hues"));
        ...
        palette_panel.setBorder(LAFManager.createTitledBorder("Palette"));
        processing_palette.setBorder(LAFManager.createTitledBorder("Processing"));
        ...
        RoundedPanel round_panel = LAFManager.createRoundedPanel();
        round_panel.setBackground(MainWindow.bg_color);
        round_panel.setPreferredSize(new Dimension(920 + (MainWindow.useCustomLaf ? extraWidth : 0), 555 + (MainWindow.useCustomLaf ? extraHeight : 0)));
        round_panel.setLayout(new GridBagLayout());
    ...
    private void paintGradientAndGraph(Color[] c) {
        ...
        if(MainWindow.useCustomLaf) {
            colors = CommonFunctions.makeRoundedCorner(colors, 5);
            gradient.setIcon(new ImageIcon(colors));
        }
