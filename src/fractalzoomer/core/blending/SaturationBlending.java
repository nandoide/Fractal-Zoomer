 ...
 * @author hrkalona2
 */
public class SaturationBlending extends Blending {

    public SaturationBlending(int color_interpolation, int color_space) {
    ...
    public int blendInternal(int redA, int greenA, int blueA, int redB, int greenB, int blueB, double coef) {
        ...
        int temp_color = Color.HSBtoRGB(hsbvals[0], hsbvalsContours[1], hsbvals[2]);
